...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\newcommand{\semester}{         SoSe 24}
\newcommand{\dateCHF}{          (25.04.)}
%         ⚠ COMMENT OUT EVERY NOT-OCCURING EVENT STARTING LINE 250 ⚠
\newcommand{\dateSommerfest}{   (28.06.)}
\newcommand{\dateSpieleabend}{  (11.04., 16.04., 24.04.)}
\newcommand{\dateGrillen}{      (27.04., 25.05.)}
%\newcommand{\dateStadtrallye}{  (20.10.)}
\newcommand{\dateKneipentour}{  (12.04., 02.05.)}
\newcommand{\dateWanderung}{    (20.04., 11.05.)}
%\newcommand{\dateFilmabend}{    (24.10.)} 
\newcommand{\dateFlunkyball}{   (17.04.)}
% \newcommand{\dateCTF}{          (17.04.)}
...
\begin{frame}{\insertsection}
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \note[item]{Bei Fragen und Problemem an die Fachschaft wenden}
...
\begin{frame}{\insertsection}
    \Large
    {\Huge\color{fsiblue} \faClock[regular]}   \timeSitzung \\[.5em]
