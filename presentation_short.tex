    ...
    \begin{columns}
        ...
        \begin{figure}
            \colorbox[HTML]{7ec850}{
                \includegraphics[height=.8\textheight]{pictures/anfiheft-info-coverSoSe25.pdf}}
        \end{figure}
