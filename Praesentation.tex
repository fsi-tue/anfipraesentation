...
%		\end{columns}
	...
	\begin{frame}{Ersti-Veranstaltungen}
		\begin{itemize}
			...
			\item Spieleabend auf dem Sand (14.10., 19 Uhr, Raum A104) %TODO Maaaarc?
			\item Anfiparty auf dem Sand (16.10., 20 Uhr, Raum A104) %TODO
		...
		\begin{columns}
			\begin{column}{.5\linewidth}
				\begin{itemize}
					...
					\item voraussichtlich Donnerstag 18:30 (st) %TODO Einladung für Ersti-Sitzung
