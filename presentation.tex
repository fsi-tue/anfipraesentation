...
\begin{document}
	...
	\begin{frame}{Heute in der Kurzversion}
		\begin{figure}[h!]
			\centering 
			\includegraphics[width=0.7\textwidth]{pictures/keinscherz.png}
		\end{figure}
	\end{frame}
...
%	 \end{frame}
		...
		\begin{columns}
			\begin{column}{.5\linewidth}
				\begin{itemize}[<+->]
					...
					\item nächstes Treffen: \\Donnerstag 25.10. 18:30 Uhr
	...
	\begin{frame}{Freizeit}
		\centering 
		\includegraphics[height=0.75\textheight]{pictures/stocherkahn.jpg}
	\end{frame}
